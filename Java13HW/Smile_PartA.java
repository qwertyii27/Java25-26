//Made by Georgio. I had no assistance except for using the template provided.

import java.awt.Color;
import java.awt.Graphics;
import javax.swing.*;

public class Smile_PartA {
    /*
    ...
    public static void draw(Graphics g) {
        ...
        g.setColor(Color.BLACK);
        g.fillOval(100, 125, 40, 40);
        g.fillOval(275, 125, 40, 40);
        // I know using a line is correct here, but I used a rectangle to increase
        // visibility.
        g.fillRect(100, 250, 215, 10);
    }
    ...
    public static void main(String[] args) {
        ...
        // set title
        frame.setTitle("Georgio's Normal Face!");
